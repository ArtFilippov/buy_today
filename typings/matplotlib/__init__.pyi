# Based on matplotlib 3.11.2, matplotlib/__init__.pyi.
...
def rc_params_from_file(
    fname: str | Path | os.PathLike[str],
    fail_on_error: bool = ...,
...
def rc_file(
    fname: str | Path | os.PathLike[str], *, use_default_template: bool = ...
) -> None: ...
@contextlib.contextmanager
def rc_context(
    rc: Mapping[RcKeyType, object] | None = ..., fname: str | Path | os.PathLike[str] | None = ...
