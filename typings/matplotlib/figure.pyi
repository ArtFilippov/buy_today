# Based on matplotlib 3.11.2, matplotlib/figure.pyi.
...
from matplotlib.typing import ColorType, HashableList, LegendLocType
...
class FigureBase(Artist):
    ...
    def suptitle(self, t: str, **kwargs: object) -> Text: ...
...
class Figure(FigureBase):
    ...
    def savefig(
        self,
        fname: str | os.PathLike[str] | IO[bytes] | IO[str],
        *,
