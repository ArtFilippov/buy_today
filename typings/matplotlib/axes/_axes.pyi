# Based on matplotlib 3.11.2, matplotlib/axes/_axes.pyi.
...
class Axes(_AxesBase):
    ...
    def legend(self, handles: Iterable[Artist | tuple[Artist, ...]], labels: Iterable[str],
               *, loc: LegendLocType | None = ..., **kwargs: object) -> Legend: ...
    @overload
    ...
    def legend(self, labels: Iterable[str],
               *, loc: LegendLocType | None = ..., **kwargs: object) -> Legend: ...
    @overload
    def legend(self, *, loc: LegendLocType | None = ..., **kwargs: object) -> Legend: ...
