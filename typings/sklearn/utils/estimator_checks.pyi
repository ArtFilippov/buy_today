# Based on scikit-learn-stubs 0.0.3, sklearn-stubs/utils/estimator_checks.pyi.
...
from sklearn.feature_selection import SelectFromModel as SelectFromModel, SelectKBest as SelectKBest
...
from sklearn.metrics import accuracy_score as accuracy_score, adjusted_rand_score as adjusted_rand_score, f1_score as f1_score
from sklearn.metrics.pairwise import linear_kernel as linear_kernel, pairwise_distances as pairwise_distances, rbf_kernel as rbf_kernel
from sklearn.model_selection import ShuffleSplit as ShuffleSplit, train_test_split as train_test_split
from sklearn.pipeline import make_pipeline as make_pipeline
from sklearn.preprocessing import StandardScaler as StandardScaler, scale as scale
from sklearn.random_projection import BaseRandomProjection as BaseRandomProjection
...
from sklearn.utils import IS_PYPY as IS_PYPY, is_scalar_nan as is_scalar_nan, shuffle as shuffle
from sklearn.utils._param_validation import Interval as Interval
...
from sklearn.utils.validation import has_fit_parameter as has_fit_parameter
