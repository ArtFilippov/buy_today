...
from buy_today.ranking.benchmark import read_latest_benchmark_runs
...
def _check_model(model):
    ...
    classes = {"random": "buy_today.ranking.random.RandomRanker", "svd": "buy_today.ranking.svd.SVDRanker"}
